...
**Characteristics:**
- Always selects the first option (default) automatically
- No waiting for user input
- Delivers always include iteration direction options (A/B/C/D) so iteration continues
...
**When triggered:**
- On delivery: Always provides A/B/C/D iteration options and auto-selects first option after 5-minute timeout
