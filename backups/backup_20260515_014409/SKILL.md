...
+------------------+       +---------------------+       +------------------+
        ...
        v                                                       v
+------------------+                                   +------------------+
|  GitHub Remote   | <------------------------------- |  sync-proposals  |
|  (CSV pushed)    |                                   |  -to-website.py  |
+------------------+                                   +------------------+
```
...
3. `sync-proposals-to-website.py` reads CSV and pushes to GitHub
...
PRJ-20260419-007,ai-creator-h5,3,https://github.com/owner/repo,/path/to/local,My project,2026-05-15
```
...
3. **GitHub CSV is merged locally** - Remote CSV data with new entries is merged INTO local CSV
4. **CSV is always pushed to GitHub** - After any change, sync script pushes CSV files to GitHub
...
| references/data-structure-gotchas.md | CSV-JSON field alignment |
