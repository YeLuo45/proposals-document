...
### P-20260522-001: creative-drawing-board V69: AI 辅助绘画引擎 (Direction A)

- **Project**: creative-drawing-board
- **Owner**: 小墨
- **Last Update**: timeout-approved
- **PRD Path**: /home/hermes/proposals/workspace-pm/proposals/P-20260522-037-prd.md
- **Project Path**: /home/hermes/projects/creative-drawing-board
- **Git**: 分支: https://github.com/YeLuo45/creative-drawing-board
---

### P-20260522-045: creative-drawing-board V69: AI 辅助绘画引擎 (Direction A)
...
### P-20260522-042: ai-subscription 模型性能分析 + 路由推荐引擎 (Direction A阶段3)
...
### P-20260522-044: ai-subscription 路由策略自动化 + A/B测试框架 (Direction A阶段4)
...
- **Git**: 分支: https://github.com/YeLuo45/cultivation-simulator
---
...
### P-20260522-041: ai-subscription Provider竞价可视化 + 路由日志增强 (Direction A阶段2交付)
...
- **Acceptance**: timeout-approved
- **Last Update**: accepted
- **Technical Solution**: /home/hermes/.hermes/proposals/workspace-pm/proposals/P-20260522-040-prd.md
- **Project Path**: /home/hermes/projects/ai-subscription
- **Git**: 分支: https://github.com/YeLuo45/ai-subscription
---

### P-20260522-043: ai-subscription 模型性能分析 + 路由推荐引擎 (Direction A阶段3交付)
...
### P-20260522-039: github-repo-manager MCP HTTP Server + Client + Web UI (Direction A)
...
- **Acceptance**: pending
- **Last Update**: 2026-05-22
- **PRD Path**: /home/hermes/proposals/workspace-pm/proposals/P-20260522-039-prd.md
- **Project Path**: /home/hermes/projects/github-repo-manager
- **Git**: 分支: master
- **Description**: Direction A无人值守模式；MCP HTTP Server+Client+Web UI测试面板
---
...
### P-20260522-043: V52: sync-to-index命令完整验证
...
### P-20260522-042: V52: sync-to-index命令完整验证
...
### P-20260522-044: V53 悟道天梯 - 天道法则可视化/悟道境界晋升/领悟历程记录

- **Project**: PRJ-20260516-002
- **Owner**: 小墨
- **Stage**: cultivation-simulator
- **Acceptance**: https://yeluo45.github.io/cultivation-simulator/
- **PRD Path**: delivered
